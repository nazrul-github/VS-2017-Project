...
namespace UniversityManagement.Controllers
{
    public class TeachersController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Name,Address,email,ContactNo,Credit,DesignationId,DepartmentId")] Teacher teacher)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Name,Address,email,ContactNo,Credit,DesignationId,DepartmentId")] Teacher teacher)
        {
            if (ModelState.IsValid)
            {
